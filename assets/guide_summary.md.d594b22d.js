import{_ as s,o as a,c as n,a as l}from"./app.4554dbcd.js";const h=JSON.parse('{"title":"总结","description":"","frontmatter":{},"headers":[{"level":2,"title":"基础Markdown语法","slug":"基础markdown语法","link":"#基础markdown语法","children":[]},{"level":2,"title":"代码块","slug":"代码块","link":"#代码块","children":[]},{"level":2,"title":"自定义容器","slug":"自定义容器","link":"#自定义容器","children":[]},{"level":2,"title":"目录","slug":"目录","link":"#目录","children":[]}],"relativePath":"guide/summary.md","lastUpdated":1673028430000}'),p={name:"guide/summary.md"},e=l(`<h1 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-hidden="true">#</a></h1><h2 id="基础markdown语法" tabindex="-1">基础Markdown语法 <a class="header-anchor" href="#基础markdown语法" aria-hidden="true">#</a></h2><hr><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">  ---分割线</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><a href="https://vitepress.vuejs.org/guide/using-vue#escaping" target="_blank" rel="noreferrer">https://vitepress.vuejs.org/guide/using-vue#escaping</a> On this page frontmatter hydration theme</p>`,21),c=[e];function o(t,i,r,C,d,A){return a(),n("div",null,c)}const u=s(p,[["render",o]]);export{h as __pageData,u as default};
